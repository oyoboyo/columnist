  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:site_name" content={config.brand.name} key="og-site-name" />
        <meta name="description" content={config.brand.tagline} key="desc" />
        <meta property="og:description" content={config.brand.tagline} key="og-desc" />
        {config.brand.image ? (
          <meta property="og:image" content={config.brand.image} key="og-image" />
        ) : null}
        <link
